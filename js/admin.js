...
window.prepararEdicionProducto = (codigo) => {
  ...
  function actualizarProducto() {
    ...
    let indiceProducto = productos.findIndex((x) => {
      return x.codigo == codigo.value;
    });
    ...
    localStorage.setItem("productoKey", JSON.stringify(productos));
    borrarFilas();
    productos.forEach((itemsProducto) => {
      crearFila(itemsProducto);
    });
    limpiarFormulario();
  }
